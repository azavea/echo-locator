export default {
  ...
  SignIn: {
    ...
    Greeting: "改善波士頓房屋管理局租賃券家庭住房搜索情況",
  ...
  Profile: {
    AddAddress: "增加另一個目的地",
    Address: "地址",
    AddressMissing: "所有目的地都應該有一個地址。請設置或去除任何留空的目的地。",
    Budget: "公寓預算",
    ByCar: "汽車",
    ByTransit: "公共交通工具",
    ...
    DeleteAddress: "刪除該地址",
    DeletePrimaryAddressError: "無法刪除主要目的地。需先設置另一個主要目的地。",
    ...
    VoucherRooms: "在您波士頓房屋管理局租賃券上的臥房數目",
    RoomsNoVoucher: "希望的臥房數目",
    Go: "保存文檔",
    NameRequired: "Please enter a name for the head of household.",
    SaveError: "保存檔案失敗。請重試。",
