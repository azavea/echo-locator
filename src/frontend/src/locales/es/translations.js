export default {
  ...
  SignIn: {
    ...
    Greeting:
      "Mejorando la búsqueda de vivienda para las familias con vales de Boston Housing Authority",
  ...
  Profile: {
    ...
    Address: "Dirección",
    AddressMissing:
      "Todos los destinos deben tener una dirección. Por favor establezca o remueva cualquier destino vacío.",
    Budget: "Presupuesto para el apartamento",
    ByCar: "Carro",
    ...
    DeleteAddress: "Borrar esta dirección",
    DeletePrimaryAddressError:
      "No se puede borrar la destinación primaria. Establezca otra como primaria primero.",
    ...
    HasVoucher: "¿Tiene un vale de Boston Housing Authority?",
    ...
    VoucherRooms: "Número de dormitorios de su vale emitido por Boston Housing Authority",
    RoomsNoVoucher: "Número de dormitorios deseados",
    Go: "Guardar mi perfil",
    NameRequired: "Por favor, introduzca un nombre para el jefe de familia.",
    SaveError: "No se pudo guardar el perfil. Por favor trate de nuevo.",
