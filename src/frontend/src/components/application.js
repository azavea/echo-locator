...
class Application extends Component<Props, State> {
  ...
  render() {
    ...
    const profileLoading =
      this.props.data.profileLoading === undefined ? true : this.props.data.profileLoading;
    ...
    return (
      <Switch>
        <Route
          ...
          path="/"
          render={() =>
            profileLoading || canViewMap ? <Redirect to="/map" /> : <Redirect to="/profile" />
          }
        />
        <Route
          path="/map"
          render={() =>
            profileLoading || canViewMap ? <MainPage {...props} /> : <Redirect to="/profile" />
          }
        />
        <Route
          path="/profile"
          render={() =>
            profileLoading || userProfile ? <EditProfile {...props} /> : <Redirect to="/" />
          }
        />
