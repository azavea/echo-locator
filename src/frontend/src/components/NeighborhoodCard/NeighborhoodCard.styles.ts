...
export const cardStyles = tv({
    slots: {
        root: "flex flex-col align-center rounded-[var(--spacing-5)] w-full bg-white shadow-md min-w-[288px]",
        image: "rounded-t-[var(--spacing-5)] h-[171px] w-full object-cover",
        closeButton:
            "absolute top-3 right-3 h-7 w-7 items-center justify-center",
        closeIcon: "h-5 fill",
        ...
        tag: "flex items-center gap-2 rounded-[var(--spacing-2)] border border-gray-300 px-2 py-1 text-xs font-bold text-green-700",
        statsContainer: "flex flex-start gap-5 self-stretch",
