...
class TopBar extends PureComponent<Props, State> {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      (this.props.bhaListings.error && prevProps.bhaListings !== this.props.bhaListings) ||
      (this.props.realtorListings.error && prevProps.realtorListings !== this.props.realtorListings)
    ) {
      this.handleError();
    }
  }
  ...
  handleShowListings = (type, e) => {
    ...
    switch (type) {
      case "BHA":
        this.props.setBHAListings({ query });
        this.props.setShowBHAListings(true);
        break;
      case "Realtor":
        this.props.setRealtorListings({ query });
  ...
  render() {
    const p = this.props;
    const { showBHAListings, showRealtorListings, bhaListings, realtorListings, t } = p;
