...
class RouteCard extends React.PureComponent<Props> {
  ...
  summaryImage(props) {
    ...
    return (
      <div className="neighborhood-summary__image" title={image.attribution}>
  ...
  render() {
    ...
    const markerClass = `neighborhood-summary__marker ${
      active ? "neighborhood-summary__marker--on" : ""
    }`;
            ...
            <div className="neighborhood-summary__trip">
              ...
              <div className="neighborhood-summary__trajectory">
                <span className="neighborhood-summary__mode">
                  ...
                  {currentDestination &&
                    t("TripPurpose." + currentDestination.purpose).toLowerCase()}
                </span>
              </div>
            </div>
          </div>
