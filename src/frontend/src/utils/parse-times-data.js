...
export function parseTimesData(ab: ArrayBuffer): TimesData {
  ...
  const header = new Int32Array(ab, 2 * Int32Array.BYTES_PER_ELEMENT, HEADER_ENTRIES);
  ...
  const data = new Int32Array(ab, HEADER_LENGTH * Int32Array.BYTES_PER_ELEMENT, gridSize * depth);
