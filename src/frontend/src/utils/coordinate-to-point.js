...
export default function coordinateToPoint(
  ...
  const pixel = Leaflet.CRS.EPSG3857.latLngToPoint(lonlat.toLeaflet(coordinate), queryZoom);
 ...
 */
const pointToOriginIndex = (point: Point, width: number) => point.x + point.y * width;
